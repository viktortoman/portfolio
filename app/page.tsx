...
export default function Portfolio() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        formData.append("access_key", "02eec5d1-0631-4e4d-ac96-884c0ddf1bba");
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-blue-500 selection:text-white relative">
            ...
            >
                <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a href="#contact" className="hidden md:block px-5 py-2 bg-slate-900 text-white rounded-lg hover:bg-blue-600 transition font-medium text-sm shadow-lg shadow-slate-300 hover:shadow-blue-200">
                            {t.nav.contactBtn}
                        </a>
                    </div>
                </div>
            ...
            <section id="contact" className="py-24 bg-slate-50 border-t border-slate-200">
                <div className="container mx-auto px-6 max-w-4xl">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        variants={fadeInUp}
                        className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl shadow-blue-900/5 border border-slate-100 relative overflow-hidden"
                    >
                        ...
                        <div className="text-center mb-12 relative z-10">
                            <h2 className="text-3xl font-black text-slate-900 mb-4">{t.contactForm.title}</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="group">
                                    <label htmlFor="name" className="block text-sm font-bold text-slate-700 mb-2 ml-1">{t.contactForm.name}</label>
                                    <input
                                        type="text"
                                        name="name"
                                        required
                                        placeholder="John Doe"
                                        className="w-full px-5 py-4 rounded-xl bg-slate-50 border border-slate-200 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10 outline-none transition-all duration-300 text-slate-800 placeholder:text-slate-400"
                                    />
                                </div>
                                <div className="group">
                                    <label htmlFor="email" className="block text-sm font-bold text-slate-700 mb-2 ml-1">{t.contactForm.email}</label>
                                    <input
                                        type="email"
                                        name="email"
                                        required
                            ...
                            <div className="group">
                                <label htmlFor="message" className="block text-sm font-bold text-slate-700 mb-2 ml-1">{t.contactForm.message}</label>
                                <textarea
                                    name="message"
                                    rows={5}
                                    required
                                    placeholder="Hello, I'd like to work with you..."
                                    className="w-full px-5 py-4 rounded-xl bg-slate-50 border border-slate-200 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10 outline-none transition-all duration-300 text-slate-800 placeholder:text-slate-400 resize-none"
                                ></textarea>
                            </div>
                            ...
                            <motion.button
                                ...
                                className={`w-full py-4 rounded-xl font-bold text-white transition-all duration-300 flex items-center justify-center gap-3 text-lg
                  ${formStatus === 'success' ? 'bg-green-500 shadow-lg shadow-green-200' :
                                    formStatus === 'error' ? 'bg-red-500 shadow-lg shadow-red-200' :
                                        'bg-gradient-to-r from-slate-800 to-slate-900 hover:shadow-xl hover:shadow-blue-500/30'}`}
                            >
            ...
            <footer className="bg-gradient-to-b from-slate-900 to-slate-950 border-t border-slate-800 text-slate-400 py-16">
